...
\begin{example}
    ...
    \begin{multline*}
        ...
        =\int\limits_{0}^{1}\frac{1}{r^{p-k+1}}\ dr\cdot \int\limits_{0}^{2\pi}1 \ d\alpha_1\cdot \int\limits_{-\frac{\pi}{2}}^{\frac{\pi}{2}}\cos{\alpha_{2}}\ d\alpha_2 \dots \int\limits_{-\frac{\pi}{2}}^{\frac{\pi}{2}}\cos{\alpha_{k-1}}\ d\alpha_{k-1}\overset{p<k}{=}\\
    ...
    \begin{multline*}
        ...
        =\int\limits_{1}^{\infty}\frac{1}{r^{p-k+1}}\ dr\cdot \int\limits_{0}^{2\pi}1 \ d\alpha_1\cdot \int\limits_{-\frac{\pi}{2}}^{\frac{\pi}{2}}\cos{\alpha_{2}}\ d\alpha_2 \dots \int\limits_{-\frac{\pi}{2}}^{\frac{\pi}{2}}\cos{\alpha_{k-1}}\ d\alpha_{k-1}\overset{p>k}{=}\\
