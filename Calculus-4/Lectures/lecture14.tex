...
\begin{proof}
    ...
    То есть прообраз не определен для точек, у которых $x_2=0,\ x_1\geq 0$.
...
\begin{example} [Интегрируемость $1/r^p$ по проколотому единичному шару и его внешности] $\\$
    ...
    и интеграл
    \[\idotsint\limits_{0<\sqrt{x_1^2+\dots+x_k^2}<1}f(x_1,\dots,x_k)\ dx_1 \dots dx_k\]
    ...
    \[\idotsint\limits_{\sqrt{x_1^2+\dots+x_k^2}>1}f(x_1,\dots,x_k)\ dx_1 \dots dx_k\]
    \begin{multline*}
