...
\begin{definition}\tab
    \begin{enumerate}
        ...
        \item Пусть $\phi_1:[\alpha_1, \beta_1]\to \R^k,\ \phi_2:[\alpha_2, \beta_2]\to \R^k$. Считаем, что $\phi_1$ и $\phi_2$ эквивалентны (параметризуют одну и ту же кривую), если существует строго монотонная биекция $g: [\alpha_1, \beta_1]\to [\alpha_2, \beta_2]$ такая, что $\phi_1\equiv \phi_2f \circ g$ на $[\alpha_1, \beta_1]$.
