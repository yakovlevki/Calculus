...
\begin{definition}[Альтернативное определение криволинейного интеграла второго рода]\tab
    \begin{enumerate}
        ...
        \[\sigma(f,T,H)=\sum\limits_{j=1}^{n}\Big(f_1(\phi(\xi_j))\Delta_{1j}+f_2(\phi(\xi_j))\Delta_{2j}+\dots+f_k(\phi(\xi_j))\Delta_{kj}\Big)\]
        \item Наконец, если
...
\begin{comm}
    ...
    где $u(x,y)$ и $v(x,y)$ --- вещественнозначные функции на кривой $\gamma$. Определим криволинейный интеграл первого рода рода от комплекснозначной функции: 
    ...
    \[\int\limits_{\gamma}f(z)\ dz:=\int\limits_{\gamma}u\ dx-v\ dy+ i \int\limits_{\gamma}v\ dx+u\ dy\]
