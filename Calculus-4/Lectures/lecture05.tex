...
\begin{comm}
    ...
    %\[\nu(\Q_{[0,1]})=0,\ \ \nu(\overline{\Q_{[0,1]}})=1\] 
\end{comm}
\noindentДалее пусть $\Phi$ --- измеримое по Жордану множество.
\begin{definition}
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        Рассмотрим разбиение $T_2$ бруса $\Pi_2$ такое, что оно совпадает с $T_1$ на $\Pi_1$ и содержит разрезы по граням $\Pi_1'$. Тогда брусы разбиения $T_2$ можно разбить на три группы:
        \begin{enumerate}
