...
\begin{proof}\tab
    \begin{enumerate}
        ...
        и рассмотрим интегральную сумму Римана-Стилтьеса:
        \begin{multline*}
            \sigma(f,T_n,H)=\sum\limits_{j=1}^{n}\left(\sum\limits_{i=1}^{k}f_i(\phi(\xi_j))\Delta_{ij}\right)=\sum\limits_{i=1}^{k}\left(\sum\limits_{j=1}^{n}f_i(\phi(\xi_j))\Delta_{ij}\right)=\\
            =\sum\limits_{i=1}^{k}\int\limits_{\Delta_i}f_1(\phi(\xi_j))\ dx_1+\dots+f_k(\phi(\xi_i))\ dx_k
        \end{multline*}
...
\begin{lemma} $\\$
    Пусть $\gamma$ --- кривая, ограничивающая область $G$ в $\R^k,\ P\in \mathcal{C}^1(\overline{\Omega}),\\
...
\end{proof}
\begin{lemma}
    Пусть $\gamma$ --- кривая, ограничивающая область $G$ в $\R^k,\ Q\in \mathcal{C}^1(\overline{\Omega}),\\
    \phi_1,\phi_2\in \mathcal{C}([a,b])$. Тогда
...
\begin{theorem}[Формула Грина для областей специального вида] $\\$
    Пусть $\gamma$ --- кривая, ограничивающая выпуклую область $G$ в $\R^k,\ P,Q\in \mathcal{C}^1(\overline{\Omega})$. Тогда 
