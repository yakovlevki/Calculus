...
\begin{document}
    ...
    \subsection{Операции над множествами (продолжение)}
        \begin{statement}
            $\bigcup\limits_{\alpha\in A}(A\setminus A_{\alpha}) = A\setminus (\bigcap\limits_{\alpha\in A}A_{\alpha})$.
        \end{statement}
        \begin{proof}
            $a\in \bigcup\limits_{\alpha\in A}(A\setminus A_{\alpha})\lra (a\in A$ и $a\notin A_{\alpha_1})$ или $\dots$ или $(a\in A$ и $a\notin A_{\alpha_n})\lra a\in A$ и $(a\notin A_{\alpha_1}$ и $\dots$ и $a\notin A_{\alpha_n})\lra A\setminus (\bigcap\limits_{\alpha\in A}A_{\alpha})$.
        \end{proof}
        \begin{statement}
            $\bigcap\limits_{\alpha\in A}(A\setminus A_{\alpha}) = A\setminus (\bigcup\limits_{\alpha\in A}A_{\alpha})$.
        \end{statement}
        \begin{proof}
            $a\in \bigcap\limits_{\alpha\in A}(A\setminus A_{\alpha})\lra (a\in A$ и $a\notin A_{\alpha_1})$ и $\dots$ и $(a\in A$ и $a\notin A_{\alpha_n})\lra a\in A$ и $(a\notin A_{\alpha_1}$ или $\dots$ или $a\notin A_{\alpha_n})\lra A\setminus (\bigcup\limits_{\alpha\in A}A_{\alpha})$.
        \end{proof}
    ...
    \subsection{Арифметические операции}
        ...
        \end{comm}
        \begin{definition}
            Если $n+k=m$, то $n=m-k, k=m-n$ называются разностью $m$ и $n$.
        \end{definition}
        \begin{comm}
            $m-0=m$, $m+0=m$, $m-m=0$.
        \end{comm}
    ...
    \subsection{Рациональные числа}
        ...
        \begin{itemize}
            ...
            \item[(9)] $a(b+c)=ab+ac$
            \item[(10)] $\forall a,b\in \Q \hspace{5pt} a\leq b$ или $b\leq q$
    ...
    \subsection{Упорядоченные и архимедовы поля}    
        \begin{definition}
            Мнножество $X$ с операциями $(\cdot, +)$ и отношением порядка $\leq$ называется упорядоченным полем.
        \end{definition}
        \begin{comm}
        ...
        \begin{definition}
            ...
            (15) $\forall x\in X \hspace{5pt} \exists n\in \N: a\leq n\cdot 1$.
        \end{definition}
        \begin{comm}
            $\Q$ - архимедово поле.
        \end{comm} 
    ...
    \subsection{Действительные числа. Аксиома полноты}
        \begin{definition}
            Множество $\R$ называется множеством действительных чисел, если $\Q \in \R$, $\R$ удовлетворяет (1)-(15) и дополнительно выполняется (16).
        \end{definition}
        \begin{definition} (Аксиома полноты)\\
            (16) $\forall A,B\subset \R$ таких, что $\forall a\in A, \forall b\in B: a\leq b \hspace{5pt} \exists c\in \R: a\leq c\leq b$.
        \end{definition}
        \begin{example}
        ...
        \end{example}
    \subsection{Модели вещественных чисел}
    \subsubsection{Модель бесконечных десятичных дробей}
        \begin{definition}
            Отображение $\{a_n\}: \N \to X$ называется последовательностью элементов $X$.
        \end{definition}
        \begin{definition}
            Выражение вида $\pm a_0,a_1,\dots, a_n, \dots$ называется бесконечной десятичной дробью, если $a_0\in \N$ или $a_0=0 \hspace{5pt} \forall i\in \N$ и $a_i \in \{0,1,\dots, 9\}$.
        \end{definition}
        \begin{definition}
            ...
            \begin{enumerate}
                ...
                \begin{itemize}
                    \item если $a_0<b_0$ или $a_0=b_0$, $a_1<b_1$ или $a_0=b_0$, $a_1=b_1$, $a_2<b_2$,\\ или \dots или $a_0=b_0$, $a_1=b_1$, $a_2=b_2, \dots, a_{n-1}=b_{n-1},$ $a_n<b_n$.
                    \item если $a_0=b_0$, $a_1=b_1, \dots, a_n\ne 9, b_n=a_{n+1}$. $a_{n+k}=9$.\\
                    $a_{n+k}=9$, $k\in \N$, $b_{n+k}=0$, $k \in \N$, т.е $a=\overline{a_0a_1...a_n(0)}$, а $b=\overline{b_0b_1...b_n(9)}$\\
        ...
        \end{theorem} 
        \begin{proof} (Еще не смог привести это в адекватный, читаемый вид. Пока что написано так, как ВЕ написал на доске)\\
            ...
            \begin{enumerate}
                ...
                \vdots \\
                $\Rightarrow \overline{b}= \overline{b_0}\overline{b_1}\overline{b_2}\dots \overline{b_n} \dots$.\\
                ...
                \item $a<0, b<0$ очевидно.
            \end{enumerate}
        \end{proof} 
        %\begin{comm}
        %    $a=a_0a_1\dots a_n\dots$, $b=b_0b_1\dots b_n\dots \Rightarrow a^{\prime}=a_0a_1\dots a_n(0),\\
        %    b^{\prime}=b_0b_1\dots b_n(0)$, $a^{\prime\prime}=a_0a_1\dots \overline{a_n+1}(0), b^{\prime\prime}=b_0b_1\dots \overline{b_n+1}(0)$.
        %\end{comm}
    ...
    \[\begin{tikzpicture}
        ...
        \end{definition}
        \begin{definition}
            Для любого промежутка с концами $\forall a,b\in \R$ длиной называется число $|b-a|$.
        \end{definition}
        \begin{definition}
        ...
        \begin{proof}
            ...
            \begin{itemize}
                ...
                \item если $m>n$, то $a_n\leq b_n\leq b_m$.
            \end{itemize}
        ...
        \end{proof} 
        \begin{definition}
            Отношение $\sim$ называется отношение эквивалентности, если оно удовлетворяет:
            \begin{enumerate}
        ...
        \begin{proof}
            ...
            $a_1=\underline{a_{11}}\ a_{12}\ a_{13}\ a_{14}\ \dots$\\
            $a_2=a_{21}\ \underline{a_{22}}\ a_{23}\ a_{24}\ \dots$\\
            $a_3=a_{31}\ a_{32}\ \underline{a_{33}}\ a_{34}\ \dots$\\
            $a_4=a_{41}\ a_{42}\ a_{43}\ \underline{a_{44}}\ \dots$\\
            $a_{ij}$ - $j$-й член $i$-й последовательности. Рассмотри последовательность $b$ у которой $b_i=1-a_{ii}$. Такая последовательность отличается от всех последовательностей на $i$-й позицции, значит она не была посчитана, получаем противоречие.
        \end{proof}
        \begin{statement}
            \begin{enumerate}
