...
\begin{document}
    ...
    \subsection{Производная функции}
        ...
        \begin{definition}
            Производной функции $f(x)$ в точке $x_0$ называется (если он существует) предел
             \[\lim\limits_{\Delta x\to 0}\frac{f(x_0+\Delta x)-f(x_0)}{\Delta x}=f^{\prime}(x_0)\]
        \end{definition} 
        \begin{definition}
            Производной функции $f(x)$ в точке $x_0$ по множесту $A$ называется (если он существует) предел 
            \[\exists \lim\limits_{A \ni \Delta x\to 0}\frac{f(x_0+\Delta x)-f(x_0)}{\Delta x}=f_A^{\prime}(x_0)\]
            Если $A=(x_0-\Delta x, x_0)$ или $(x_0,x_0+\Delta x)$, то пишут $f_{-}^{\prime}$ или $f_{+}^{\prime}$. 
        \end{definition} 
        ...
        \begin{theorem}
            ...
            \begin{enumerate}
                \item $\exists\ (Cf(x))^{\prime}=C f^{\prime}(x_0)$.
                \item $\exists\ (f(x)\pm g(x))^{\prime}=f^{\prime}(x_0)\pm g^{\prime}(x_0)$.
            \end{enumerate}
        \end{theorem} 
        \begin{theorem}
            Если $\exists\ f^{\prime}(x_0)$ и $\exists\ g^{\prime}(x_0)$, то $\exists\ (f(x)g(x))^{\prime}=f^{\prime}(x_0)g(x_0)+g^{\prime}(x_0)f(x_0)$.
        \end{theorem} 
        \begin{proof}
            \begin{multline*}
        ...
        \begin{theorem}
            ...
            \[\exists\ (\frac{f(x)}{g(x)})^{\prime}=\frac{f^{\prime}(x_0)g(x_0)-f(x_0)g^{\prime}(x_0)}{g^2(x_0)}\]
        \end{theorem} 
        \begin{proof}
            \begin{multline*}
        ...
        \begin{proof}
            ...
            \[\lim\limits_{x_n\to x_0}\frac{g(f(x_n))-g(f(x_0))}{x_n-x_0}=\lim\limits_{x_n\to x_0}\frac{g(f(x_n))-g(f(x_0))}{f(x_n)-f(x_0)}\cdot \frac{f(x_n)-f(x_0)}{x_n-x_0}\]
            В любой окрестности $x_0$ есть бесконечно много точек, в которых $f(x_n)=f(x_0)$. Тогда
    ...
    \subsection{Дифференцируемые функции}
        \begin{definition}
            Разность $f(x_0=\Delta x)-f(x_0)$ называют полным приращением функции
        \end{definition} 
        \begin{definition}
        ...
        \begin{proof}\tab
            \begin{enumerate}
                \item $(\Rightarrow)$ $f(x_0+\Delta x)-f(x_0)=A\Delta x+\bar{\bar{o}}{(\Delta x)}\Rightarrow$
        ...
        \begin{comm}\tab
            \begin{enumerate}
                ...
                \item $d(g(f(x)))=g^{\prime}(f(x))f^{\prime}(x)dx=g^{\prime}(f(x))df$\\
        ...
        \begin{examples}\tab
            \begin{enumerate}
                ...
                2xdx+2ydy=0 \Leftrightarrow dy=-\cfrac{x}{y}\ dx=-\cfrac{x}{\sqrt{1-x^2}}\ dx$.
                \item $\begin{cases}
                    x=x(t),\\
                    y=y(t).       
                \end{cases}$\
                ...
                $\begin{cases}
                    ...
                    x=x(t).       
                \end{cases}$
                \\(В ПРИМЕРАХ ВРЕМЕННО МОГУТ БЫТЬ ОШИБКИ)
            \end{enumerate}
        \end{examples}
        \begin{theorem}
            Пусть $\exists\ y^{\prime}=f^{\prime}(x_0),\ f^{\prime}(x_0)\ne 0$. Тогда \\
            $\exists\ x=f^{-1}(y)$ и $(f^{-1}(y_0))^{\prime}=\frac{1}{f^{\prime}(x_0)}$
        \end{theorem} 
        \begin{proof}
    ...
    \subsection{Касательная. Геометрический смысл первого дифференциала}
        \begin{definition}
            Луч $l_0=l(\alpha_0,(x_0,y_0))$ с началом в точке $(x_0,y_0)$ и углом к $Ox\ \alpha_0\in [-\pi,\pi]$ называется предельным положением семейства лучей $l(t),\\
            t\in I, t_0\in I$, если они начинаются в той же самой точке $(x_0,y_0)$ и $\lim\limits_{x\to x_0}\alpha(t)=\alpha_0$.
        \end{definition} 
        \begin{definition}
        ...
        \begin{center}
            \begin{tikzpicture}[scale=2]
                ...
                \draw[domain=0.3:2.5,samples=100] plot (\x,{0.5*(\x)^2});
        ...
        \begin{definition}
            Пусть $f(x)$ определена в $B(x_0),\ f(x)\in \mathcal{D}(B(x_0))$. Если $\exists (f'(x))'|_{x=x_0}$, то говорят, что у функции есть вторая производная в точке $x_0$, и обозначают $f''(x_0)$. Аналогично определяется производная порядка $n\in \N$, обозначают $f^{(n)}(x)$.
        \end{definition} 
        \begin{definition}
            Пусть $f(x)\in \mathcal{D}(B(x_0))$. Пусть $f'(x)\in \mathcal{D}(B(x_0))$. Возмем первый дифференциал от первого дифференциала 
            \[\delta(f'(x)dx)=\delta(f'(x))dx=f''(x)\delta x dx\ \ (\ast)\]
            Выражение $(\ast)$, взятое при $\delta x=dx$, называется вторым дифференциалом $f(x)$, обозначается $d^2f(x)=f''(x)(dx)^2\ (=f''(x)dx^2)$. Аналогично определяется дифференциал порядка $n\in \N$
            \[\delta(f^{(n-1)}(x)dx)=f^{(n)}(x)dx^{n-1}\delta x|_{\delta x=\delta dx}=f^{(n)}dx^n=d^nf\]
        \end{definition} 
        ...
        \begin{theorem} (Теорема Ферма)\\
            Пусть $f(x)$ определена в $B(x_0)$, пусть существует левая и правая поизводные в точке $x_0$. Тогда $f'_-(x)\geq 0$, если $x_0$ - точка максимума $(\leq 0, \min)$. $f'_+(x_0)\leq 0$ - точка максимума $(\geq 0, \min)$
        \end{theorem} 
        \begin{proof} (для возрастающей)\\
            $\frac{f(x)-f(x_0)}{x-x_0}\geq 0$, если $x\in (x_0-\delta,x_0) \Rightarrow f'_-(x_0)\geq 0$.\\
            $\frac{f(x)-f(x_0)}{x-x_0}\leq 0$, если $x\in (x_0,x_0+\delta) \Rightarrow f'_+(x_0)\leq 0$.
        \end{proof} 
        \begin{consequense}
        ...
        \end{theorem}  
        \begin{proof}
            Пусть $\phi(x)=f(x)-\frac{f(b)-f(a)}{b-a}(x-a).\ \phi(a)=f(a),\\
            \phi(b)=f(a) \Rightarrow \exists\ c\in (a,b): \phi'(c)=0=f'(c)-\frac{f(b)-f(a)}{b-a}$.
        \end{proof} 
        ...
        \end{proof} 
        \subsection{Геометрический смысл и приложения формулы Лагранжа}
        Рисунок\\
        $f(b)-f(a)=f'(c)(b-a) \Leftrightarrow f'(c)=\frac{f(b)-f(a)}{b-a}$.
        \begin{theorem} (Формула Коши)\\
            $f(x),\ g(x)\in \mathcal{C}[a,b],\ f,g \in \mathcal{D}(a,b),\ g'(x)\ne 0 \forall x\in (a,b)$. Тогда $\exists\ c\in (a,b)$ такая, что
            \[\frac{f(b)-f(a)}{g(b)-g(a)}=\frac{f'(c)}{g'(c)}\]
        \end{theorem} 
        \begin{proof}
            Заметим, что $g(b)\ne g(a)$, так как иначе, по теореме Ролля $\exists\ c: g'(x)=0$. Введем функцию 
            \[\phi(x)=f(x)-\frac{f(b)-f(a)}{g(b)-g(a)}(g(x)-g(a))\]
            $\phi(b)=f(a),\ \phi(a)=f(a)$. Тогда по теореме Ролля $\exists\ c:$
            \[\phi(c)=0=f'(c)-\frac{f(b)-f(a)}{g(b)-g(a)}g'(c)\]
        \end{proof} 
        \begin{theorem} (Связь монотонной и знака производной)\tab
            \begin{enumerate}
                \item Пусть $f(x)$ неубывает(невозрастает) на $(a,b)$ и $f(x)\in \mathcal{D}(a,b)$. Тогда $f'(c)\geq 0 (\leq 0)$.
                \item Пусть $f'(x)\geq 0 (\leq 0)$. Тогда $f(x)$ неубывает (невозрастает).
                \item Пусть $f'(x)>0 (<0)$. Тогда $f(x)$ строго возрастает (строго убывает).
            \end{enumerate}
        \end{theorem} 
        \begin{proof}\tab
            \begin{enumerate}
                \item Пусть неубывает $\forall x_1,x_2\in (a,b): \frac{f(x_2)-f(x_1)}{x_2-x_1}\geq 0 \Rightarrow f'(x)\geq 0$.
                \item $\forall x_1,x_2\in (a,b): f(x_2)-f(x_1)=f'(c)(x_2-x_1)$.
                \item $\forall x_1,x_2\in (a,b): f(x_2)-f(x_1)=f'(c)(x_2-x_1)$.
            \end{enumerate}
        \end{proof} 
        \begin{theorem}
            Пусть $f(x)\in \mathcal{C}(B(x_0)),\ f(x)\in \mathcal{D}(\mathring{B}(x_0))$. Если $\exists \lim\limits_{x\to x_0-0}f'(x_0)=f'(x_0-0)$. Тогда $\exists\ f'_-(x_0)=f'(x_0-0)$. Если $\exists\ \lim\limits_{x\to x_0+0}f'(x)=f'(x_0+0)$, то $\exists\ f'_+(x_0)=f'(x_0+0)$.
        \end{theorem}
        ПРИМЕР
        \begin{proof}
            $\frac{f(x)-f(x_0)}{x-x_0}=f'(c)$. При $x\to x_0+0: c\to x_0+0$. Тогда $\exists \lim\limits_{x\to x_0+0}f'(c)=f'(x_0+0) \Leftrightarrow \lim\limits_{x\to x_0+0}\frac{f(x)-f(x_0)}{x-x_0}=f'_+(x_0)$.
        \end{proof} 
        \begin{consequense}
            Если $f(x)\in \mathcal{D}$, то $f'(x)$ может иметь разрывы только второго рода.
        \end{consequense} 
        \begin{proof}\tab
            \begin{enumerate}
                \item Если $f'_-(x_0)=f'_+(x_0)$, то $\exists f'(x_0)=f'_-(x_0)=f_+(x_0)$, значит не бывает устранимых разрывов.
        ...
        \begin{proof}
            ...
            \begin{enumerate}
                ...
                \item Пусть $A\ne B$ - любые, $C$ - между $A$ и $B$ - любое. Рассмотри функцию $g(x)=f(x)-Cx$. Тогда $g'(a)=A-C,\ g'(b)=B-C$ и ищем точку $c$ такую, что $g'(c)=0$. Заметим, что $g'(a)$ и $g'(b)$ разных знаков $\Rightarrow g'(c)=0$ (свели к первому и второму случаю).
            \end{enumerate}
        \end{proof} 
        \subsection{Правила Лопиталя}
        \begin{theorem}
            Пусть $f(x),g(x)\in \mathcal{D}(B(x_0)),\ f(x_0)=g(x_0)=0,\ g(x)\ne 0$ в $\mathring{B}(x_0),\\
            g'(x)\ne 0$ в $B(x_0)$. Тогда $\lim\limits_{x\to x_0}\frac{f(x)}{g(x)}=\frac{f'(x_0)}{g'(x_0)}$
        \end{theorem} 
        \begin{proof}
        ...
        \end{proof} 
        \begin{theorem}
            Пусть $f,g\in \mathcal{D}(\mathring{B}(x_0)),\ \lim\limits_{x\to x_0}f(x)=0,\ \lim\limits_{x\to x_0}g(x)=0,\ g(x)\ne 0$ в $\mathring{B}(x_0),\ g'(x)\ne 0$ в $\mathring{B}(x_0)$. Тогда если $\exists \lim\limits_{x\to x_0}\frac{f'(x)}{g'(x)}=A$, то $\exists \lim\limits_{x\to x_0}\frac{f(x)}{g(x)}=A$, и если $\lim\limits_{x\to x_0}\frac{f'(x)}{g'(x)}=\infty$, то $\lim\limits_{x\to x_0}\frac{f(x)}{g(x)}=\infty$.
        \end{theorem} 
        \begin{proof}при $x\to x_0,\ c\to x_0$.
            \[\frac{f(x)-f(x_0)}{g(x)-g(x_0)}=\frac{f'(c)}{g'(c)}=\frac{f(x)}{g(x)}\]
            Если $\lim\limits_{x\to x_0}\frac{f'(c)}{g'(c)}=A$, то $\lim\limits_{x\to x_0}\frac{f'(c)}{g'(c)}=A \Rightarrow \exists\ \lim\limits_{x\to x_0}\frac{f(x)}{g(x)}=A$.\\
            Если $\frac{f'(c)}{g'(c)}\to \infty,\ x\to x_0$, то $\frac{f'(c)}{g'(c)}=\frac{f(x)}{g(x)}\to \infty$ при $x\to x_0$.
        \end{proof} 
        \begin{theorem}
            Пусть $f(x), g(x)\in \mathcal{D}(a,+\infty),\ \exists \lim\limits_{x\to +\infty}f(x)=0,\ \exists \lim\limits_{x\to +\infty}g(x)=0,\ g(x)\ne 0,\ f(x)\ne 0$, тогда если $\exists \lim\limits_{x\to +\infty}\frac{f'(x)}{g'(x)}=A$, то $\exists \lim\limits_{x\to +\infty}=A$. Если $\frac{f'}{g'}\to \infty,\ x\to +\infty$, то $\frac{f}{g}\to \infty,\ x\to +\infty$. 
        \end{theorem} 
        \begin{proof}
