    ...
    \subsection{Касательная. Геометрический смысл первого дифференциала}
        ...
        \begin{center}
            \begin{tikzpicture}[scale=1]
                ...
                \draw[dashed] (x2) -- (y2);
                \draw (y1) -- (y2);
                \draw[dashed] [domain=1:2.5, samples=2] plot (\x, {0.938* (\x) +0.965});
                \draw[dashed] [domain=3.5:5, samples=2] plot (\x, {0.938* (\x) -0.6});
            \end{tikzpicture}
        \end{center}
        ...
        \begin{theorem} (Связь монотонной функции и знака ее производной)\tab
            \begin{enumerate}
                \item Пусть $f(x)$ неубывает (невозрастает) на $(a,b)$ и $f(x)\in \mathcal{D}(a,b)$. Тогда $f'(c)\geq 0\ (f'(c)\leq 0)\ \forall c\in (a,b)$.
                \item Пусть $f'(x)\geq 0\ (f'(x)\leq 0)$. Тогда $f(x)$ неубывает (невозрастает).
                \item Пусть $f'(x)>0\ (f'(x)<0)$. Тогда $f(x)$ строго возрастает (строго убывает).
            \end{enumerate}
        \end{theorem} 
        ...
        \begin{theorem}
            ...
            \begin{enumerate}
                ...
                \item Если $\exists\ \lim\limits_{x\to x_0+0}f'(x)=f'(x_0+0)$, то $\exists\ f'_+(x_0)$ и $f'_+(x_0)=f'(x_0+0)$.
            \end{enumerate}
        \end{theorem}
        \begin{proof}
            \[f'(c)=\frac{f(x)-f(x_0)}{x-x_0},\ x\to x_0+0,\ c\to x_0+0\]
            Тогда 
            \[\exists \lim\limits_{x\to x_0+0}f'(c)=f'(x_0+0) \Leftrightarrow \lim\limits_{x\to x_0+0}\frac{f(x)-f(x_0)}{x-x_0}=f'_+(x_0)\]
        \end{proof} 
        \begin{consequense}
        ...
        \end{theorem} 
        \begin{proof} При $x\to x_0,\ c\to x_0$ справедливо:
        ...
        \begin{theorem}
            ...
            g(x)\ne 0,\ f(x)\ne 0$, тогда если $\exists \lim\limits_{x\to +\infty}\frac{f'(x)}{g'(x)}=A$, то $\exists \lim\limits_{x\to +\infty}=A$.\\
