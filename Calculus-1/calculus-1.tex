...
\begin{document}
    ...
    \subsection{Касательная. Геометрический смысл первого дифференциала}
        ...
        \begin{definition}\tab
            \begin{enumerate}
                \item $\tg{\alpha_+}=\lim\limits_{x\to x_0+0}\frac{f(x)-f(x_0)}{x-x_0}=f^{\prime}_+(x_0)$.
                \item $\tg{\alpha_-}=\lim\limits_{x\to x_0-0}\frac{f(x)-f(x_0)}{x-x_0}=f^{\prime}_-(x_0)$.
            \end{enumerate} 
        \end{definition} 
        \begin{center}
            \begin{tikzpicture}[scale=2]
                ...
                \draw[fill] (x0) circle (1pt) node[below right] {$x_0$};
                \draw[fill] (x1) circle (1pt) node[below right] {$x_0 + \Delta x$};
                \draw[fill] (y0) circle (1pt) node[above left] {$f(x_0)$};
                \draw[fill] (y1) circle (1pt) node[above left] {$f(x_0 + \Delta x)$};
                \draw[fill] (y2) circle (1pt);
                \draw[fill] (y3) circle (1pt);
                \draw[fill] (y4) circle (1pt) node[above left] {$df$};

                \draw[ultra thick] (0, 1.5) -- (0, 2);
                ...
                \draw[dashed][domain=0:1,samples=2] plot (\x, {0.5});
