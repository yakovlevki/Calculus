    ...
    \section{Числовые последовательности}
        ...
        \begin{proof}
            ...
            \begin{enumerate}
                ...
                \item $|a_n+b_n|\leq|a_n|+|b_n|<2\epsilon$. Поскольку $\epsilon$ принимает любое вещественное положительное значение, то величина $2\epsilon$ - тоже $\Rightarrow a_n+b_n=\bar{\bar{o}}{(1)}$.
