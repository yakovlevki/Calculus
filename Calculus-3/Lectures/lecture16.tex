...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \[ \int\limits_{-\pi}^{\pi} f \cdot T_N \ dx = \frac{A_0}{2} \int\limits_{-\pi}^{\pi} f \ dx + \sum\limits_{n=1}^{N}\left(A_n \cdot \int\limits_{-\pi}^{\pi}f\cdot \cos{(nx)} \ dx + B_n \cdot \int\limits_{-\pi}^{\pi}f \cdot \sin{(nx)}\ dx \right)\]
