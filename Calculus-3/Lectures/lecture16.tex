...
\begin{theorem}
    ...
    где $T_N$ --- тригонометрический полином степени не выше $N$, $\min\limits_T$ означает, что минимум берется по всем тригонометрическим многочленам степени не превосходящей $N$.
\end{theorem}
\begin{proof}
