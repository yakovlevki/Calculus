...
\begin{proof}
    ...
    подставим $t-n$ и $t$ в выражение $(*)$ для дифференциала:
    \begin{multline*}
    ...
    \begin{multline*}
        ...
        =\sqrt{2\pi n}+\int\limits_{-\infty}^{+\infty}(1-\theta_n)e^{-x^2}\ dx^2=\sqrt{2\pi n}+\beta_n,\ |\beta_n|\leq 4
    \end{multline*}
    итого
