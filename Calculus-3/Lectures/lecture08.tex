...
\begin{proof}
    ...
    \begin{multline*}
        ...
        \overset{(2)}{\leq}(1+|a_n|)\cdot \left(\prod\limits_{k=1}^{n-1}(1+|a_k|)-1\right)+|a_n|=\prod\limits_{k=1}^{n}(1+|a_k|)-1
    \end{multline*}
    (1): Добавили и вычли $a_n$.\\
    (2): По предположению индукции и неравенству треугольника
    \[|1+a_n|\leq 1+|a_n|\]
\end{proof}
\begin{lemma}
...
\begin{proof}
    ...
    Возьмем $t\in \R,\ |t|<n, m<n$ и представим произведение в виде
    ...
    \begin{multline*}
        ...
        \leq \prod\limits_{k=m+1}^{n}\left(1+\frac{t^2}{(\frac{2}{\pi}\cdot \pi k)^2}\right)-1=\prod\limits_{k=m+1}^{n}\left(1+\frac{t^2}{4k^2}\right)-1\leq\\
        \leq \prod\limits_{k=m+1}^{\infty}\left(1+\frac{t^2}{4k^2}\right)-1
    \end{multline*}
