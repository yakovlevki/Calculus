...
\begin{proof}
    \begin{multline*}
        ...
        =\frac{\alpha}{\beta}\int\limits_{0}^{1}x^{\alpha-1}(1-x)^{\beta}\ dx=\frac{\alpha}{\beta}\int\limits_{0}^{1}x^{\alpha-1}(1-x)(1-x)^{\beta-1}\ dx=\\
...
\begin{statement} (Свойства тригонометрической системы)\\
    ...
    \[\forall n\geq 1\ \int\limits_{0}^{\pi}\sin^2{(nx)}\ dx=\int\limits_{0}^{\pi}\cos^2{(nx)}\ dx=\frac{\pi}{2}\]
