\begin{theorem} (Признак Коши)\\
    ...
    \begin{enumerate}
        \item Если $\exists\ q: 0<q<1,\ \forall n>N: \sqrt[n]{a_n}\leq q$, то ряд ($*$) сходится.
...
\begin{theorem} (Признак Д'Аламбера)\\
    ...
    \begin{enumerate}
        \item Если $\exists\ q:\ 0<q<1,\ \forall n>N: \frac{a_{n+1}}{a_n}\leq q$, то ряд $(*)$ сходится.
        \item Если $\exists\ \{n_k\}_{k=1}^{\infty}: \frac{a_{n_{k + 1}}}{a_{n_k}}\geq 1$, то ряд $(*)$ расходится.
    \end{enumerate}
\end{theorem}
\begin{proof}\tab
    \begin{enumerate}
        ...
        По признаку сравнения с геометрической прогрессией, ряд
        \[\sum\limits_{k=0}^{\infty}a_{N+k}\]
        сходится, значит, ряд $(*)$ также сходится.
...
\begin{examples}\tab
        ...
        Значит, если
        \[n\cdot \left(\frac{a_n}{a_{n+1}}-1\right)\geq 1+\alpha\]
        то ряд ($*$) сходится. Теперь
        \[n\cdot \frac{a_n}{a_{n+1}}-n-1\leq 0\]
        Значит, если
        \[n\cdot \left(\frac{a_n}{a_{n+1}}-1\right)\leq 1\]
        то ряд ($*$) расходится.
        Запишем в предельной форме:\\
        Если
        \[\exists\ \lim\limits_{n\to\infty}n\cdot\left(\frac{a_n}{a_{n+1}}-1\right)=q>1\]
        то ряд ($*$) сходится. Если
        \[\exists\ \lim\limits_{n\to\infty}n\cdot\left(\frac{a_n}{a_{n+1}}-1\right)=q<1\]
        то ряд ($*$) расходится.
        ...
        Если
        \[\ln{n}\cdot\left(n\left(\frac{a_n}{a_{n+1}}-1\right)-1\right)\geq 1+\alpha\]
        то ряд $(*)$ сходится. Если
        \[\ln{n}\cdot\left(n\left(\frac{a_n}{a_{n+1}}-1\right)-1\right)\leq 1\]
        то ряд $(*)$ расходится. Запишем в предельной форме:\\
        Если 
        \[\exists\ \lim\limits_{n\to\infty}\left(\ln{n}\cdot\left(n\left(\frac{a_n}{a_{n+1}}-1\right)-1\right)\right)=q>1\]
        то ряд ($*$) сходится. Если
        \[\exists\ \lim\limits_{n\to\infty}\left(\ln{n}\cdot\left(n\left(\frac{a_n}{a_{n+1}}-1\right)-1\right)\right)=q<1\]
        то ряд ($*$) расходится.
