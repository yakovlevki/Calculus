...
\begin{proof}
    ...
    \begin{multline*}
        \overline{\overline{S}}(T_1)-\overline{\overline{S}}(T)=m_{1j}(x_j'-x_j)+m_{2j}(x_{j+1}-x_j')-m_j(x_{j+1}-m_j)=\\
...
\end{numlemma} 
\begin{proof}
    Докажем для верхней суммы. Рассмотрим множество $\{X_i: X_i\subset \R\}_{i=1}^n$ такое, что\\
