...
\begin{proof}
    \begin{multline*}
        ...
        \begin{pmatrix}
            ...
            \vdots & \null & \vdots\\
            \frac{\partial {f_k}}{\partial {x_1}} & \dots & \frac{\partial {f_k}}{\partial {n}}
        \end{pmatrix}
        \cdot 
        \begin{pmatrix}
            \Delta x_1\\
...
\begin{proof}
    ...
    \[
        \det{J}=\begin{vmatrix}
            \frac{\partial {f_1}}{\partial {y_1}} & \dots & \frac{\partial {f_1}}{\partial {y_n}} & \frac{\partial {f_m}}{\partial {y_{m+1}}}\\
            \vdots & \null & \vdots\\
            \frac{\partial {f_k}}{\partial {y_1}} & \dots & \frac{\partial {f_m}}{\partial {y_n}} & \frac{\partial {f_m}}{\partial {y_{m+1}}}\\
            \frac{\partial {f_{m+1}}}{\partial {y_1}} & \dots & \frac{\partial {f_{m+1}}}{\partial {y_m}} & \frac{\partial {f_{m+1}}}{\partial {y_{m+1}}}
        \end{vmatrix}
    \]
    имеет ненулевой минор, значит система
    \[\begin{cases}
        f_1 = 0,\\
        \vdots\\
        f_m=0
    ...
    \[\begin{cases}
        \frac{\partial {f_1}}{\partial {y_1}} \frac{\partial {\psi_1}}{\partial {y_{m+1}}}+\frac{\partial {f_1}}{\partial {y_2}} \frac{\partial {\psi_2}}{\partial {y_{m+1}}}+ \dots +\frac{\partial {f_1}}{\partial {y_m}} \frac{\partial {\psi_m}}{\partial {y_{m+1}}}+\frac{\partial {f_1}}{\partial {y_{m+1}}}=0\\
        \vdots\\
        \frac{\partial {f_m}}{\partial {y_1}} \frac{\partial {\psi_1}}{\partial {y_{m+1}}}+\frac{\partial {f_m}}{\partial {y_2}} \frac{\partial {\psi_2}}{\partial {y_{m+1}}}+ \dots +\frac{\partial {f_m}}{\partial {y_m}} \frac{\partial {\psi_m}}{\partial {y_{m+1}}}+\frac{\partial {f_m}}{\partial {y_{m+1}}}=0\\
        \frac{\partial {f_{m+1}}}{\partial {y_1}} \frac{\partial {\psi_1}}{\partial {y_{m+1}}}+\frac{\partial {f_{m+1}}}{\partial {y_2}} \frac{\partial {\psi_2}}{\partial {y_{m+1}}}+ \dots +\frac{\partial {f_{m+1}}}{\partial {y_m}} \frac{\partial {\psi_m}}{\partial {y_{m+1}}}+\frac{\partial {f_{m+1}}}{\partial {y_{m+1}}}=\frac{\partial {g}}{\partial {y_{m+1}}}
    \end{cases}
    \]
...
\begin{comm} (О вычислении производных)\\
    ...
    \Rightarrow
    \begin{cases}
        \sum\limits_{i=1}^{n}\frac{\partial {f_1}}{\partial {x_1}}dx_i+\sum\limits_{j=1}^{m}\frac{\partial {f}}{\partial {y_j}}dy_j=0\\
        \vdots\\
        \sum\limits_{i=1}^{n}\frac{\partial {f_m}}{\partial {x_i}}dx_i+\sum\limits_{j=1}^{m}\frac{\partial {f}}{\partial {y_j}}dy_j=0
    \end{cases}
    \Rightarrow
    \begin{cases}
