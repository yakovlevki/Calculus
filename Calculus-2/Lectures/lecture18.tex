...
\begin{proof}
    ...
    \[\phi'(\xi)=\sum\limits_{i=1}^{n}\frac{\partial {F}}{\partial {x_i}}(\bar{x}_0+\xi(\bar{x}-\bar{x}_0))(x_i-x_{0i})+\frac{\partial {F}}{\partial {y}}(\bar{x}_0+\xi(\bar{x}-\bar{x}_0))(f(\bar{x})-f(\bar{x}_0))=0\]
    \begin{multline*}
        (f(\bar{x})-f(\bar{x}_0))=-\sum\limits_{i=1}^{n}\frac{\frac{\partial {F}}{\partial {x_i}}(\bar{x}_0+\xi(\bar{x}-\bar{x}_0))}{\frac{\partial {F}}{\partial {y}}(\bar{x}_0+\xi(\bar{x}-\bar{x}_0))}(x_i-x_{0i})=\\
        =-\sum\limits_{i=1}^{n}\frac{\frac{\partial {F}}{\partial {x_i}}(\bar{x}_0)}{\frac{\partial {F}}{\partial {y}}(\bar{x}_0)}(x_i-x_{0i})+\sum\limits_{i=1}^{n}\left(\frac{\frac{\partial {F}}{\partial {x_i}}(\bar{x}_0)}{\frac{\partial {F}}{\partial {y}}(\bar{x}_0)}-\frac{\frac{\partial {F}}{\partial {x_i}}(\bar{x}_0+\xi(\bar{x}-\bar{x}_0))}{\frac{\partial {F}}{\partial {y}}(\bar{x}_0+\xi(\bar{x}-\bar{x}_0))}\right)(x_i-x_{0i})=\\
