...
\begin{proof} 
    ...
    \begin{multline*}
        ...
        =\Delta_x(f'_y(x,y+\Delta_y)\Delta_y)=f''_{xy}(x+\theta_1\Delta x,y+\theta_2\Delta y)\Delta y \Delta x
    \end{multline*}
    Аналогично
        \[\Delta_y(\Delta_x f(x,y))=f''_{xy}(x+\theta_3 \Delta x, y+\theta_4 \Delta y)\Delta x\Delta y\]
    Устремим $\sqrt{\Delta x^2+\Delta y^2}\to 0$. Значит
